...
Odpowiedź:  Dioda świeci się.

## Zadanie 2-2-2:
Pytanie:    *Czy zamienienie kolejności podłączenia diody LED i rezystora ma znaczenie?*  
Odpowiedź: Nie ma znaczenia, czy rezystor będzie przedd diodą, czy za nią.

## Zadanie 2-2-3:
Pytanie:    *Czy każdy rodzaj pętli jest wymienny (zawsze można zastąpić jedną konstrukcję drugą)?*  
Odpowiedź: Jest wymienny, a decyzja, którą należy użyć w danym momencie, zależy głównie od kontekstu, w jakim ma być wykorzystana.
...
Odpowiedź:  Nagłe zmiany śwaiteł mogą być niebezpieczne dla ruchu.
